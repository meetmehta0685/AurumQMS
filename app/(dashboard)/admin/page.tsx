  ...
  useEffect(() => {
    const fetchAdminData = async () => {
      try {
        ...
        const [doctorsRes, patientsRes, departmentsRes, appointmentsRes] =
          await Promise.all([
            supabase
              .from("doctors")
        ...
        const mappedAppointments: RecentAppointment[] = appointments
          .slice(0, 5)
          .map((apt: any) => ({
            id: apt.id,
        ...
        <div className="flex justify-between items-center mb-8 bg-card/80 backdrop-blur-sm rounded-2xl p-4 shadow-lg">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              variant="outline"
              size="icon"
              className="rounded-xl border-border hover:bg-destructive/10 hover:text-destructive hover:border-destructive/50"
            >
          ...
          <Card className="border-0 shadow-xl bg-card/80 backdrop-blur-sm">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-chart-4">
                {loadingData ? "..." : stats.totalDoctors}
              </div>
          ...
          <Card className="border-0 shadow-xl bg-card/80 backdrop-blur-sm">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-chart-1">
                {loadingData ? "..." : stats.totalPatients}
              </div>
              <p className="text-sm text-muted-foreground mt-1">
                Registered users
              </p>
          ...
          <Card className="border-0 shadow-xl bg-card/80 backdrop-blur-sm">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-chart-3">
                {loadingData ? "..." : stats.totalDepartments}
              </div>
              <p className="text-sm text-muted-foreground mt-1">
          ...
          <Card className="border-0 shadow-xl bg-card/80 backdrop-blur-sm">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-chart-2">
                {loadingData ? "..." : stats.todayAppointments}
              </div>
            ...
            <Link href="/admin/doctors">
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div>
                    <CardTitle className="group-hover:text-chart-4 transition-colors">
                      Manage Doctors
                    </CardTitle>
                    <CardDescription>
              ...
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <CardDescription>
                      Create and organize hospital departments
                    </CardDescription>
                  </div>
          ...
          <Card className="border-0 shadow-xl bg-card/80 backdrop-blur-sm hover:shadow-2xl transition-all duration-300 cursor-pointer group">
            <Link href="/admin/appointments">
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div>
                    <CardTitle className="group-hover:text-chart-3 transition-colors">
                      View Appointments
                    </CardTitle>
                    <CardDescription>
          ...
          <Card className="border-0 shadow-xl bg-card/80 backdrop-blur-sm hover:shadow-2xl transition-all duration-300 cursor-pointer group">
            <Link href="/admin/laboratory">
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div>
                    <CardTitle className="group-hover:text-chart-2 transition-colors">
                      Laboratory
                    </CardTitle>
                    <CardDescription>
                      Monitor all test orders and reports
                    </CardDescription>
                  </div>
                  <div className="w-12 h-12 bg-chart-2/10 rounded-xl flex items-center justify-center group-hover:bg-chart-2/20 transition-colors">
                    <FlaskConical className="w-6 h-6 text-chart-2" />
                  </div>
                </div>
              </CardHeader>
              <CardContent>
              ...
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <CardDescription>
                      Track medicine dispensing hospital-wide
                    </CardDescription>
                  </div>
              ...
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <CardDescription>
                      Track generated discharge PDFs
                    </CardDescription>
                  </div>
                  <div className="w-12 h-12 bg-chart-3/10 rounded-xl flex items-center justify-center group-hover:bg-chart-3/20 transition-colors">
                    <FileDown className="w-6 h-6 text-chart-3" />
                  </div>
                </div>
              </CardHeader>
              <CardContent>

      ...
      for (const apt of transformedAppointments) {
        if (apt.token_number && apt.doctor?.id) {
          ...
          if (doctorQueue) {
            ...
            const completedTokens = doctorQueue.filter(
      ...
      <div className="max-w-4xl mx-auto p-4 sm:p-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-muted-foreground mt-1">
            Track your position in today&apos;s queue
          </p>
        </div>
        ...
        {todayAppointments.length === 0 ? (
          ...
          <div className="space-y-6">
            {todayAppointments.map((apt) => {
              const position = queuePositions.find(
              ...
              return (
                <Card
                  key={apt.id}
                  className="border-0 shadow-xl bg-card/80 backdrop-blur-sm overflow-hidden"
                >
                      ...
                      <div className="space-y-6">
                        ...
                        {position.patientsAhead === 0 ? (
                          ...
                          <div className="p-4 bg-accent rounded-xl border border-border text-center">
                            <p className="text-accent-foreground">
                              Please wait in the waiting area. We&apos;ll call
                              your token soon.
                            </p>
                          </div>
                        )}
                        ...
                        <div className="flex items-center justify-center gap-2 text-muted-foreground">
                          ...
                          <span className="text-sm">
                            Scheduled for {apt.appointment_time}
                          </span>
                        </div>
                      </div>
                    ) : (

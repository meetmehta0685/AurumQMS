        ...
        if (appointments) {
          ...
          const mappedAppointments: UpcomingAppointment[] = appointments
            ...
            .map((apt: any) => ({
              ...
              patient: Array.isArray(apt.patient)
                ? apt.patient[0]
                : apt.patient,
            }));
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                className="gap-2 border-border hover:bg-destructive/10 hover:text-destructive hover:border-destructive/20 transition-colors"
              >
          ...
          <Card className="border-0 shadow-xl bg-card/80 backdrop-blur-sm">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-chart-4">
                {loadingData ? "..." : stats.patientsInQueue}
              </div>
              <p className="text-sm text-muted-foreground mt-1">
          ...
          <Card className="border-0 shadow-xl bg-card/80 backdrop-blur-sm">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-chart-2">
                {loadingData ? "..." : stats.completedToday}
              </div>
              <p className="text-sm text-muted-foreground mt-1">
              ...
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <CardDescription>
                      Manage your patient queue and token system
                    </CardDescription>
                  </div>
              ...
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <CardDescription>
                      Create test orders and upload reports
                    </CardDescription>
                  </div>
                  <div className="w-12 h-12 bg-chart-3/10 rounded-xl flex items-center justify-center group-hover:bg-chart-3/20 transition-colors">
                    <FlaskConical className="w-6 h-6 text-chart-3" />
                  </div>
                </div>
              </CardHeader>
              <CardContent>
              ...
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <CardDescription>
                      Track medicines and dispensing status
                    </CardDescription>
                  </div>
                  <div className="w-12 h-12 bg-chart-2/10 rounded-xl flex items-center justify-center group-hover:bg-chart-2/20 transition-colors">
                    <Pill className="w-6 h-6 text-chart-2" />
                  </div>
                </div>
              </CardHeader>
              <CardContent>
